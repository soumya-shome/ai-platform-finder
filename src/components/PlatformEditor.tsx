...
const PlatformEditor: React.FC<PlatformEditorProps> = ({ platform, onSave }) => {
  ...
  const defaultValues: PlatformFormValues = {
    ...
    pricing: {
      hasFree: platform.pricing.hasFree,
      freeDescription: platform.pricing.freeDescription || "",
      hasPaid: platform.pricing.hasPaid,
      startingPrice: platform.pricing.startingPrice || "",
    },
  };
  ...
  const onSubmit = async (data: PlatformFormValues) => {
    ...
    try {
      ...
      const pricing = {
        ...
        paidPlans: platform.pricing.paidPlans || [],
      };
